...
// Row 0: Half-inch plates (triangular side panels - largest parts)
layout_triangular_side(1000, 900, PLATE_1_2, "A1-L Side Panel Left", START_X, START_Y);
layout_triangular_side(1000, 900, PLATE_1_2, "A1-R Side Panel Right", START_X + 1000 + SPACING, START_Y);

// Row 0.5: Back connecting plate
layout_part(1000, 700, PLATE_1_4, "A3 Back Plate", START_X, START_Y + 900 + SPACING);

// Row 1: Half-inch plates (wheel mounts and high-stress parts)
layout_part(250, 250, PLATE_1_2, "A4-1 Wheel Mount FL", START_X, START_Y + 900 + 700 + 2*SPACING);
layout_part(250, 250, PLATE_1_2, "A4-2 Wheel Mount FR", START_X + 250 + SPACING, START_Y + 900 + 700 + 2*SPACING);
layout_part(250, 250, PLATE_1_2, "A4-3 Wheel Mount RL", START_X + 2*(250 + SPACING), START_Y + 900 + 700 + 2*SPACING);
layout_part(250, 250, PLATE_1_2, "A4-4 Wheel Mount RR", START_X + 3*(250 + SPACING), START_Y + 900 + 700 + 2*SPACING);

// Row 2: Half-inch plates continued
layout_part(200, 200, PLATE_1_2, "C2-1 Bucket Attach L", START_X, START_Y + 900 + 700 + 250 + 3*SPACING);
layout_part(200, 200, PLATE_1_2, "C2-2 Bucket Attach R", START_X + 200 + SPACING, START_Y + 900 + 700 + 250 + 3*SPACING);
layout_part(100, 150, PLATE_1_2, "Cyl Lug 1", START_X + 2*(200 + SPACING), START_Y + 900 + 700 + 250 + 3*SPACING);
layout_part(100, 150, PLATE_1_2, "Cyl Lug 2", START_X + 2*(200 + SPACING) + 100 + SPACING, START_Y + 900 + 700 + 250 + 3*SPACING);
layout_part(100, 150, PLATE_1_2, "Cyl Lug 3", START_X + 2*(200 + SPACING) + 2*(100 + SPACING), START_Y + 900 + 700 + 250 + 3*SPACING);
layout_part(100, 150, PLATE_1_2, "Cyl Lug 4", START_X + 2*(200 + SPACING) + 3*(100 + SPACING), START_Y + 900 + 700 + 250 + 3*SPACING);

// Base Y for quarter-inch parts
base_y = START_Y + 900 + 700 + 250 + 200 + 4*SPACING;
...
text("LifeTrac v25 CNC Layout - Triangular Side Panel Design", size=16, font="Liberation Sans:style=Bold");
...
text("A1-L/R: Triangular side panels (sandwich arm joints)", size=8);
