// frame_tube_t2_rear.scad
// Rear Frame Tube - Part T2
// 2" × 6" × 1/4" Rectangular Tubing
// Rear cross frame tube passing through side panels
// Quantity needed: 1
...
// Render the part
frame_tube_t2_rear(show_holes=false);
