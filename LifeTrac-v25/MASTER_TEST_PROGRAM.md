...
**Last updated:** 2026-04-29 (Round 41).
...
|---|---|---|---|
| **SIL** (software-in-the-loop) | CI on every push, pure Python stdlib + project deps | Logic, protocol, state-machine regressions; cross-language byte-identity (C ↔ Python). **No hardware required.** | **571 tests** across [48 files](#2-sil-test-catalog) |
...
**Totals:** 48 files, 571 tests, 1 skipped.
...
As of Round 41 every "—" cell that has a natural SIL surface is
