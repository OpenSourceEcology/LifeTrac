...
int main(void) {
    static const cfg_case_t k_cases[] = {
        ...
        {
            "lbt_max_backoff_min_ok",
            CFG_KEY_LBT_MAX_BACKOFF_MS,
            { LE16_LO(10U), LE16_HI(10U) },
            2U,
            CFG_STATUS_OK,
            true,
            { LE16_LO(10U), LE16_HI(10U) },
        ...
        {
            "lbt_max_backoff_oor_low",
            CFG_KEY_LBT_MAX_BACKOFF_MS,
            { LE16_LO(9U), LE16_HI(9U) },
            2U,
            CFG_STATUS_OUT_OF_RANGE,
            true,
            { LE16_LO(500U), LE16_HI(500U) },
            2U,
            false,
            false,
            0U
        ...
        {
            "fhss_dwell_ok",
            CFG_KEY_FHSS_DWELL_MS,
            { LE16_LO(401U), LE16_HI(401U) },
            2U,
            CFG_STATUS_OK,
            true,
            { LE16_LO(401U), LE16_HI(401U) },
        ...
        },
        {
            "fhss_dwell_oor_high",
            CFG_KEY_FHSS_DWELL_MS,
            { LE16_LO(2001U), LE16_HI(2001U) },
            2U,
            CFG_STATUS_OUT_OF_RANGE,
            true,
            { LE16_LO(400U), LE16_HI(400U) },
            2U,
            false,
            false,
            0U
