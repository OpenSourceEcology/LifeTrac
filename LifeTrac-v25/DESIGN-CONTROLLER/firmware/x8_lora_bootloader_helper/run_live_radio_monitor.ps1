...
param(
    ...
    # clamp still applies, so this can only go below the ceiling. Used for
    # the SIR discriminator on the fixed RF switch.
    [string]$TxPowerDbm = "",
