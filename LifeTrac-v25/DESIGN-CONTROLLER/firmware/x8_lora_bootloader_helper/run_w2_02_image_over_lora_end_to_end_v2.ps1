...
# v2 orchestrator: external w2_02_radio_wake_rxcont.py step REMOVED.
# The auto-wake (RegOpMode 0x80 -> 0x85) is now performed inside
# method_h_stage2_tx_probe_v2.py's run_rx_listen and emitted as
# __V2_AUTOWAKE__ in rx_stdout.txt.
