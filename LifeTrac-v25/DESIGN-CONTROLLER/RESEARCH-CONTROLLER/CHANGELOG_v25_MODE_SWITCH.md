...
4. **DESIGN-CONTROLLER/WIRING_DIAGRAM.md**
...
- [DROIDPAD_BLE_SETUP.md](DESIGN-CONTROLLER/DROIDPAD_BLE_SETUP.md) - Complete BLE setup guide
- [MODE_SWITCH_WIRING.md](MODE_SWITCH_WIRING.md) - Hardware wiring instructions
- [DROIDPAD_INTEGRATION.md](DESIGN-CONTROLLER/DROIDPAD_INTEGRATION.md) - General DroidPad guide
- [INSTALLATION_GUIDE.md](INSTALLATION_GUIDE.md) - Complete installation guide
- [DESIGN-CONTROLLER/WIRING_DIAGRAM.md](DESIGN-CONTROLLER/WIRING_DIAGRAM.md) - System wiring diagrams
