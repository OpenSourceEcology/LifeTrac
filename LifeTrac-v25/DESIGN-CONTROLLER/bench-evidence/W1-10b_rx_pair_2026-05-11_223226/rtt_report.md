...
# build_timestamp_utc: 2026-05-20T07:50:00Z
# profile_enum: 0
...
Evidence dir: C:\Users\dorkm\Documents\GitHub\LifeTrac\LifeTrac-v25\DESIGN-CONTROLLER\bench-evidence\W1-10b_rx_pair_2026-05-11_223226
TX_DONE rows parsed: 1126  (status==OK: 1126)
RX_FRAME rows parsed: 1024  matched-to-TX-by-payload: 1024

--- Time-on-air (LATENCY_BUDGET §1 row #2) ---
  toa (firmware-reported)          n=1126 min=  30.85 p50=  30.85 p95=  30.85 p99=  30.85 max=  30.85 ms
  predicted SF7/BW125 ~30.0 ms   measured-vs-predicted: +2.8%

--- Host-to-host TX-confirm (rows #1 + #2 + #3 + LPUART) ---
  elapsed_ms (TX_FRAME_REQ -> TX_DONE_URC) n=1126 min=  42.20 p50=  51.90 p95=  56.30 p99=  57.90 max=  60.80 ms
  budget for this segment: ToA + ~5.0 ms host overhead = ~35.0 ms

--- RX inter-arrival jitter (cross-check) ---
  rx_iat (L072 hw timestamp_us)    n=1023 min=  92.97 p50= 102.95 p95= 107.97 p99= 109.40 max= 214.38 ms
...
--- Estimated radio-link RTT (bench-tier surrogate) ---
  ...
  rtt_p99_estimate_ms = 2 * elapsed_p99 = 115.80 ms
