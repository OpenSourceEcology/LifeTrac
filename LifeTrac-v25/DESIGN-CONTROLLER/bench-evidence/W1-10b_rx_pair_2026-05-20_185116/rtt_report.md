...
Evidence dir: C:\Users\dorkm\Documents\GitHub\LifeTrac\LifeTrac-v25\DESIGN-CONTROLLER\bench-evidence\W1-10b_rx_pair_2026-05-20_185116
TX_DONE rows parsed: 1000  (status==OK: 1000)
RX_FRAME rows parsed: 993  matched-to-TX-by-payload: 993

--- Time-on-air (LATENCY_BUDGET §1 row #2) ---
  toa (firmware-reported)          n=1000 min=  30.85 p50=  30.85 p90=  30.85 p95=  30.85 p99=  30.85 p999=  30.85 max=  30.85 ms
  predicted SF7/BW125 ~30.0 ms   measured-vs-predicted: +2.8%

--- Host-to-host TX-confirm (rows #1 + #2 + #3 + LPUART) ---
  elapsed_ms (TX_FRAME_REQ -> TX_DONE_URC) n=1000 min=  42.50 p50=  52.00 p90=  56.10 p95=  56.40 p99=  59.90 p999=  60.60 max=  60.70 ms
  budget for this segment: ToA + ~21.0 ms host overhead = ~51.0 ms

--- RX inter-arrival jitter (cross-check) ---
  rx_iat (L072 hw timestamp_us)    n=992  min=  95.00 p50= 103.12 p90= 107.73 p95= 107.95 p99= 110.76 p999= 211.12 max= 211.61 ms
