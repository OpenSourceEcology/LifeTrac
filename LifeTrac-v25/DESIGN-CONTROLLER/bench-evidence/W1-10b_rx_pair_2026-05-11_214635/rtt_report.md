...
# build_timestamp_utc: 2026-05-20T07:49:58Z
# profile_enum: 0
...
Evidence dir: LifeTrac-v25\DESIGN-CONTROLLER\bench-evidence\W1-10b_rx_pair_2026-05-11_214635
...
--- Host-to-host TX-confirm (rows #1 + #2 + #3 + LPUART) ---
  elapsed_ms (TX_FRAME_REQ -> TX_DONE_URC) n=100  min=  45.80 p50=  55.80 p95=  56.70 p99=  60.20 max=  60.20 ms
  budget for this segment: ToA + ~5.0 ms host overhead = ~35.0 ms

--- RX inter-arrival jitter (cross-check) ---
  rx_iat (L072 hw timestamp_us)    n=99   min= 249.97 p50= 257.77 p95= 258.60 p99= 261.95 max= 262.09 ms
  expected ~= TX inter_cycle_s + 1x ToA jitter

--- Estimated radio-link RTT (bench-tier surrogate) ---
  rtt_p50_estimate_ms = 2 * elapsed_p50 = 111.60 ms
