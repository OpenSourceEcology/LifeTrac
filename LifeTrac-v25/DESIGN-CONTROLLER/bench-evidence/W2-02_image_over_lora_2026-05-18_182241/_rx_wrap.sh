...
# build_timestamp_utc: 2026-05-20T07:50:14Z
# profile_enum: 0
...
#!/bin/sh
cd /tmp/lifetrac_p0c && echo fio | sudo -S -p '' python3 -u method_h_stage2_tx_probe.py --dev /dev/ttymxc3 --baud 921600 --probe rx_listen --rx-window 107
rc=$?
