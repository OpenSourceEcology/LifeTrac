...
Evidence dir: C:\Users\dorkm\Documents\GitHub\LifeTrac\LifeTrac-v25\DESIGN-CONTROLLER\bench-evidence\W1-10b_rx_pair_2026-05-11_231533
...
--- Time-on-air (LATENCY_BUDGET §1 row #2) ---
  toa (firmware-reported)          n=2000 min=  30.85 p50=  30.85 p95=  30.85 p99=  30.85 max=  30.85 ms
  predicted SF7/BW125 ~30.0 ms   measured-vs-predicted: +2.8%

--- Host-to-host TX-confirm (rows #1 + #2 + #3 + LPUART) ---
  elapsed_ms (TX_FRAME_REQ -> TX_DONE_URC) n=2000 min=  42.40 p50=  51.80 p95=  56.10 p99=  57.80 max=  61.30 ms
  budget for this segment: ToA + ~5.0 ms host overhead = ~35.0 ms

--- RX inter-arrival jitter (cross-check) ---
  rx_iat (L072 hw timestamp_us)    n=1998 min=  93.03 p50= 103.05 p95= 107.87 p99= 108.70 max= 209.98 ms
