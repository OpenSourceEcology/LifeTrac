...
# build_timestamp_utc: 2026-05-20T07:50:03Z
# profile_enum: 0
...
Evidence dir: LifeTrac-v25\DESIGN-CONTROLLER\bench-evidence\W1-10b_rx_pair_2026-05-11_231533
TX_DONE rows parsed: 2000  (status==OK: 2000)
RX_FRAME rows parsed: 1999  matched-to-TX-by-payload: 1999

--- Time-on-air (LATENCY_BUDGET §1 row #2) ---
  toa (firmware-reported)          n=2000 min=  30.85 p50=  30.85 p90=  30.85 p95=  30.85 p99=  30.85 p999=  30.85 max=  30.85 ms
  predicted SF7/BW125 ~30.0 ms   measured-vs-predicted: +2.8%

--- Host-to-host TX-confirm (rows #1 + #2 + #3 + LPUART) ---
  elapsed_ms (TX_FRAME_REQ -> TX_DONE_URC) n=2000 min=  42.40 p50=  51.80 p90=  55.90 p95=  56.10 p99=  57.80 p999=  60.40 max=  61.30 ms
  budget for this segment: ToA + ~21.0 ms host overhead = ~51.0 ms

--- RX inter-arrival jitter (cross-check) ---
  rx_iat (L072 hw timestamp_us)    n=1998 min=  93.03 p50= 103.05 p90= 107.65 p95= 107.87 p99= 108.70 p999= 112.30 max= 209.98 ms
