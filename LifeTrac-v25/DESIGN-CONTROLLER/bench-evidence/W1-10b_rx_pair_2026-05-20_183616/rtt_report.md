...
Evidence dir: C:\Users\dorkm\Documents\GitHub\LifeTrac\LifeTrac-v25\DESIGN-CONTROLLER\bench-evidence\W1-10b_rx_pair_2026-05-20_183616
...
--- Time-on-air (LATENCY_BUDGET §1 row #2) ---
  toa (firmware-reported)          n=100  min=  30.85 p50=  30.85 p90=  30.85 p95=  30.85 p99=  30.85 p999=  30.85 max=  30.85 ms
  predicted SF7/BW125 ~30.0 ms   measured-vs-predicted: +2.8%

--- Host-to-host TX-confirm (rows #1 + #2 + #3 + LPUART) ---
  elapsed_ms (TX_FRAME_REQ -> TX_DONE_URC) n=100  min=  48.20 p50=  55.30 p90=  56.50 p95=  56.80 p99=  58.30 p999=  60.40 max=  60.40 ms
  budget for this segment: ToA + ~21.0 ms host overhead = ~51.0 ms

--- RX inter-arrival jitter (cross-check) ---
  rx_iat (L072 hw timestamp_us)    n=97   min= 250.16 p50= 257.31 p90= 258.48 p95= 258.89 p99= 504.83 p999= 511.64 max= 511.64 ms
...
--- Estimated radio-link RTT (bench-tier surrogate) ---
  ...
  rtt_p99_estimate_ms = 2 * elapsed_p99 = 116.60 ms
