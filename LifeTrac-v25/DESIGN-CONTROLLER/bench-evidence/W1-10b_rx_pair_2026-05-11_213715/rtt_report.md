...
# build_timestamp_utc: 2026-05-20T07:49:57Z
# profile_enum: 0
...
Evidence dir: LifeTrac-v25\DESIGN-CONTROLLER\bench-evidence\W1-10b_rx_pair_2026-05-11_213715
...
--- Host-to-host TX-confirm (rows #1 + #2 + #3 + LPUART) ---
  elapsed_ms (TX_FRAME_REQ -> TX_DONE_URC) n=200  min=  42.50 p50=  55.40 p95=  57.10 p99=  60.60 max=  61.70 ms
  budget for this segment: ToA + ~5.0 ms host overhead = ~35.0 ms

--- RX inter-arrival jitter (cross-check) ---
  rx_iat (L072 hw timestamp_us)    n=199  min= 243.23 p50= 257.34 p95= 258.66 p99= 262.77 max= 263.37 ms
...
--- Estimated radio-link RTT (bench-tier surrogate) ---
  ...
  rtt_p99_estimate_ms = 2 * elapsed_p99 = 121.20 ms
