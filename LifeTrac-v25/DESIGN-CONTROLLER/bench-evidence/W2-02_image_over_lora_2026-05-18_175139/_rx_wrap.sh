...
# build_timestamp_utc: 2026-05-20T07:50:10Z
# profile_enum: 0
...
#!/bin/sh
echo fio | sudo -S -p '' env LIFETRAC_PROBE_MODE=rx_listen LIFETRAC_RX_WINDOW=106 bash /tmp/lifetrac_p0c/run_method_h_stage2_tx.sh
rc=$?
