...
- [DESIGN-CONTROLLER/WIRING_DIAGRAM.md](DESIGN-CONTROLLER/WIRING_DIAGRAM.md) - Full system wiring
- [DROIDPAD_BLE_SETUP.md](DESIGN-CONTROLLER/DROIDPAD_BLE_SETUP.md) - BLE control setup
