...
SYNC_KEYS: List[str] = [
    ...
    "HOST_RX_FRAME_URC_TAIL_LEN",
    "HOST_RX_FRAME_URC_PHASE_VALID",
    ...
    # RS-12.15 v2 additive tail (168..204): mirrored in mh_wire.h; the PR #125
    # review noted these were not enforced -- a drift in the H7 copy must
    # fail this check, not just the L072 build.
    "HOST_STATS_OFFSET_FHSS_DEC_ALIGNED",
    "HOST_STATS_OFFSET_FHSS_DEC_SNAPPED",
    "HOST_STATS_OFFSET_FHSS_DEC_REJ_NOT_INIT",
    "HOST_STATS_OFFSET_FHSS_DEC_REJ_BAD_HOP",
    "HOST_STATS_OFFSET_FHSS_DEC_REJ_EPOCH_DRIFT",
    "HOST_STATS_OFFSET_FHSS_DEC_REJ_LOCKED_OUT",
    "HOST_STATS_OFFSET_CLK_DEMOTION_RESET",
    "HOST_STATS_OFFSET_CLK_DEMOTION_KEPT",
    "HOST_STATS_OFFSET_TX_FIRST_ANCHOR",
    "HOST_STATS_OFFSET_TX_STREAM_STREAK_MAX",
