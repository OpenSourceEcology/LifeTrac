...
gets a PowerShell harness skeleton with the §0 setup checklist, the
...
1. Plug in the hardware and complete the §0 common setup from
   [`HIL_RUNBOOK.md`](../HIL_RUNBOOK.md).
2. Edit the three placeholders at the top of `_common.ps1` for your bench:
...
4. Run the harness, e.g. `pwsh ./w4-01_estop_latency.ps1 -Operator "alice" -Sf 7`.
