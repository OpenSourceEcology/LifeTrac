...
Tractor 12 V battery
        ...
        └──► Opta WiFi 12-24 V power input
                │
                ├──► 4× onboard 10 A relays:
                │       R1: drive LH forward
                │       R2: drive LH reverse
                │       R3: drive RH forward
                │       R4: drive RH reverse
                │
                ├──► 8× onboard digital/analog inputs:
                │       I1-I4: spare digital
                │       I5-I8: spare analog
                │
                ├──► Ext D1608S (DIN rail):
                ...
                │       R7: bucket curl
                │       R8: bucket dump
                │       R9: engine kill (through PSR safety relay)
                │       R10-R12: spare AUX outputs
                │       I9: ignition sense
                │       I10: external E-stop loop monitor
                │       I11-I16: spare digital inputs (mode switch, limit switches, etc.)
                │
                └──► Ext A0602 (DIN rail):
