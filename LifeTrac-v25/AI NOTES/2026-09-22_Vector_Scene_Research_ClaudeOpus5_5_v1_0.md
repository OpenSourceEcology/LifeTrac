...
| Encode modes | `EncodeMode` 0–7 on the base (`lora_proto.py:80-91`); the tractor adds `RAWSTREAM = 8`, which the base rejected (`camera_service.py:501`; `image_rx_daemon.py:1175-1203`) until #131 added it to the enum with a parity test (2026-09-24). `wireframe` (3) is a legacy alias for grey WebP at q ≤ 20; no wireframe or vector code runs. |
