...
* **[LifeTrac v25](LifeTrac-v25/)** - Remote control system with LoRa/MQTT communication (Work in Progress)
...
* [LifeTrac v25](https://wiki.opensourceecology.org/wiki/LifeTrac_v25) - Remote control system featuring LoRa/MQTT communication for hydraulic operation control. Includes Arduino Opta controller, ROS2 integration, and web-based interface with live camera feed. (Work in Progress)
